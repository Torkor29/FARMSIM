 ...
 *
 * Sans mémoire des prix, une cotation ne veut rien dire : 265 CRD la tonne
  ...
  return (
    <div className={`sparkline ${trend}`}>
      <svg
        ...
        role="img"
        aria-label={`Cours sur la période : ${pct}, de ${first.toFixed(0)} à ${last.toFixed(0)} CRD la tonne`}
      >
