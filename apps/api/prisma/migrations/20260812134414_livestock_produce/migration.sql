...
INSERT INTO "new_Herd" ("bornAt", "buildingId", "farmId", "grazingUntil", "happiness", "id", "kind", "lastGrazedAt", "lastMilkedAt", "lastTickAt", "size") SELECT "bornAt", "buildingId", "farmId", "grazingUntil", "happiness", "id", "kind", "lastGrazedAt", "lastMilkedAt", "lastTickAt", "size" FROM "Herd";
DROP TABLE "Herd";
